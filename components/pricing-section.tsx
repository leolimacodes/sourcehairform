    ...
    <section className="relative py-24 px-4">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            <Sparkles className="w-4 h-4 text-[#e1bb26]" />
          ...
          >
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                !isAnnual ? "bg-[#e1bb26] text-black shadow-lg" : "text-white/60 hover:text-white/80"
              }`}
            >
              Monthly
            </button>
          ...
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-8 backdrop-blur-sm border transition-all duration-300 ${
                plan.popular
                  ? "bg-gradient-to-b from-[#e1bb26]/10 to-transparent border-[#e1bb26]/30 shadow-lg shadow-[#e1bb26]/10"
                  : "bg-white/5 border-white/10 hover:border-white/20"
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-[#e1bb26] to-[#fdd602] text-black text-sm font-medium px-4 py-2 rounded-full">
                    Most Popular
                  </div>
                </div>
              )}
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-center gap-3">
                    <Check className="w-5 h-5 text-[#e1bb26] flex-shrink-0" />
              ...
              <motion.button
                ...
                className={`w-full py-3 px-6 rounded-lg font-medium transition-all duration-200 ${
                  plan.popular
                    ? "bg-gradient-to-r from-[#e1bb26] to-[#fdd602] text-black shadow-lg shadow-[#e1bb26]/25 hover:shadow-[#e1bb26]/40"
